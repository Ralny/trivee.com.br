...
<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/admin/pages/css/login3.css"/>
...
<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/admin/layout/css/layout.css"/>
<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/admin/layout/css/themes/default.css" id="style_color"/>
<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/admin/layout/css/custom.css"/>
<!-- END THEME STYLES -->
<link rel="shortcut icon" href="<?= base_url() ?>assets/zata/favicon.ico"/>
</head>
<!-- END HEAD -->
<!-- BEGIN BODY -->
<body class="login" style="background: url('<?= base_url() ?>assets/zata/whistler_coast_mountains_dock-wide.jpg') no-repeat;
">
<!--<body class="login">-->
...
<div class="content">
	...
	<div class="logo">
		<a href="./">
		<img src="<?= base_url() ?>assets/zata/logo.png" alt="" width="250"/>
		</a>
	</div>
	<!-- END LOGO -->
	<!-- BEGIN LOGIN FORM -->
...
<script type="text/javascript" src="<?= base_url() ?>assets/admin/layout/scripts/layout.js"></script>
<script type="text/javascript" src="<?= base_url() ?>assets/admin/layout/scripts/demo.js"></script>
<script type="text/javascript" src="<?= base_url() ?>assets/admin/pages/scripts/login.js"></script>
