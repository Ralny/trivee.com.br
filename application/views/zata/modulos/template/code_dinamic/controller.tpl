...
class {controller} extends MY_Controller 
{
     ...
     */
    public $modulo  = '{url_modulo}';

    public $url     = '{url_modulo}';
    ...
    {       
         ...
         * Loading Model 
         */
        $this->load->model('{controller}_model');
    ...
    public function listar()
    {
         ...
         * View 
         */
        $page_data['page']          = '{folder_view}/main-list';
    ...
    */    
    public function cadastrar()
    {
         ...
         * View 
         */
        $page_data['page']          = '{folder_view}/form';
    ...
    */    
    public function editar()
    {
        ...
        if(!$id)
        {
             ...
             */ 
            $this->log_zata->log_error('Danger','Acesso indevido: {controller}->editar() --> Parâmetro ID nao numerico');
        ...
        else // Se o parametro esta CORRETO - If the parameter is CORRECT
        {
            ...
            if (!$this->model->getRow($id))
            {
                 ...
                 */
                $this->log_zata->log_error('Error','Acesso invalido: {controller}->editar() --> O registro nao foi encontrado no banco de dados. ');
    ...
    */
    function excluir($id) 
    {
        ...
        else
        {
             ...
             */
            $this->log_zata->log_error('Error', 'Falha ao excluir: {controller}->excluir() --> Nao foi possivel excluir o registro '. $id);
