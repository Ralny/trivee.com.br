				...
				<form action="<?= base_url().$url ?>/salvar" method="post" id="form_sample_1" <?= $form_class ?>>
					...
					<div class="form-body">
						...
						<?php 
							...
							<div class="form-group">
								<label class="control-label col-md-2">Cor da categoria</label>
								<div class="col-md-2">
									<div class="input-group color colorpicker-default" data-color="<?=  isset($show->color_label) ? $show->color_label : '#3865a8' ;?>" data-color-format="rgba">
										<input type="text" class="form-control" value="<?=  isset($show->color_label) ? $show->color_label : '#3865a8' ;?>" readonly="" name="color_label">
										<span class="input-group-btn">
											<button class="btn default" type="button"><i style="background-color: <?=  isset($show->color_label) ? $show->color_label : '#3865a8' ;?>);"></i>&nbsp;</button>
										</span>
									</div>
