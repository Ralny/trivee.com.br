							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<div class="input-group input-medium date date-picker"  data-date-format="dd-mm-yyyy" data-date-viewmode="years">
											<input type="text" class="form-control" name="dth_inicio" id="dth_inicio">
												<span class="input-group-btn">
						...
						<div class="row">
							...
							<div class="col-md-2">
								<div class="form-group">
									...
									<div class="input-group">
										<input value="<?php //=  isset($show->nome_sala) ? $show->nome_sala : null ;?>" name="acrescimo" data-required="1" type="text" class="form-control"/>
							...
							<div class="col-md-2">
								<div class="form-group">
									...
									<input readonly name="valor_total" type="text" class="form-control"/>
								</div>
							</div>
							<div class="col-md-2">
								<div class="form-group">
									<label class="control-label">Valor Total com Taxas</label>
						...
						<div class="row">
							<div class="col-md-9">
								<div class="form-group">
									...
									<textarea name="observacoes_sala" class="form-control autosizeme" rows="6"></textarea>
								</div>
							</div>
						</div>
	...
	jQuery(document).ready(function() {
		...
		$("#balcao").click(function() {
				...
				if ($(this).prop("checked", true)){
					 ...
					 */
					?>
					 var trf_balcao = moeda2float($('input[name="trf_balcao"]').val());
		...
		$("#especial_iss").click(function() {
				...
				if ($(this).prop("checked", true)){
					 ...
					 */
					?>
					var trf_especial = moeda2float($('input[name="trf_especial"]').val());
	...
	$("select[name=id_sala]").change(function(){
		...
		$.getJSON( path + 'eventos/Eventos_salas/ajax_get_sala/' + id_sala, function (data){
			...
			$.each(data, function(i, obj){
				...
				var valor_total_taxas = ajusta_iss(trf_especial_formatado);
