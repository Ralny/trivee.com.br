				...
				<form action="<?= base_url() ?>infra/infra_solicitacao_servico/salvar_tarefa" method="post" id="form_sample_1" <?= $form_class ?>>
					...
					<div class="form-body">
						...
						<div id="repeticao" style="visibility:hidden;  display:none;"> 
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<div class="col-md-10">
												<div class="col-md-12">
													<label class="control-label col-md-2">às/aos</label>
													<div class="col-md-10">
														<div class="input-group">
															<div class="icheck-inline">
							...
							<div id="mensal" style="visibility:hidden;  display:none;"> <!-- Mensal -->
												...
												<div class="col-md-12">
													<div class="input-group">
														<div class="icheck-list">
															<label>
																<input type="radio" name="sit_status" value="Pra fazer" class="icheck" data-radio="iradio_square-blue" checked>Em
															</label>
															<label>
																<input type="radio" name="sit_status" value="Fazendo" class="icheck" data-radio="iradio_square-blue">no
															</label>
													...
													<label class="control-label col-md-2">No dia</label>
													<div class="col-md-3">
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												<div class="col-md-12">
													...
													<div class="col-md-3">
														<select name="id_status_solicitacao" class="form-control select2me" data-placeholder="Selecionar...">
															<option value="Primeiro(s)">Primeiro(s)</option>
