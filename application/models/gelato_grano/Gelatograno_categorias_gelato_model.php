...
/**
 * Class Model Gelatograno_categorias_gelato 
 *
 ...
 * @author    Ralny Andrade | <ra@trivee.com.br> | https://github.com/ralny
 */
class Gelatograno_categorias_gelato_model extends MY_Model {
    ...
    */
    public function __construct()
    {
         ...
         * Set the table name
         */
        $this->table    = "gelato_grano_categoria";
        
        /**
         * Definir o nome da chave primaria
         * Define the primary key name
         */
        $this->primaryKey = "id_categoria_gelato";
