 ...
 * @author    Ralny Andrade | <ra@trivee.com.br> | https://github.com/ralny
 */
class Categorias_solicitacao_servico_model extends MY_Model {
    ...
    */
    public function __construct()
    {
         ...
         * Set the table name
         */
        $this->table    = "ss_cat_solicitacao_servico";
    ...
    public function cat_solicitacao_servico($categoria){
        ...
        $sql = "
                SELECT * FROM ss_cat_solicitacao_servico WHERE token_id =  '$categoria'   
               "; 
