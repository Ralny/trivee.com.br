...
/**
 * Class Model Infra_areas_instalacoes 
 *
 ...
 * @author    Ralny Andrade | <ra@trivee.com.br> | https://github.com/ralny
 */
class Infra_areas_instalacoes_model extends MY_Model {
    ...
    */
    public function __construct()
    {
         ...
         * Set the table name
         */
        $this->table    = "infra_areas_e_instalacoes";
        
        /**
         * Definir o nome da chave primaria
         * Define the primary key name
         */
        $this->primaryKey = "id_area_instalacao";
        
    } 


    /**
     * Listar Locais e Instalacoes
     *
     * Retorna lista de locais e instalacoes
     */
    public function listar_locais_instalacoes(){
        ...
        $sql = "
                SELECT
                  i.*
                FROM
                  infra_areas_e_instalacoes i
                WHERE
                  i.token_company = '$this->company'
                ORDER BY  
                  i.desc_area_instalacao  
               ";
