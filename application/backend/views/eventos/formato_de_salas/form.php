				...
				<form action="<?= base_url().$url ?>/salvar" method="post" id="form_sample_1" <?= $form_class ?>>
					...
					<div class="form-body">
						...
						<div class="form-group">
							<label class="control-label col-md-2">Formato de Sala <span class="required"> * </span></label>
							<div class="col-md-5">
								<input value="<?=  isset($show->desc_formato_de_sala) ? $show->desc_formato_de_sala : null ;?>" name="desc_formato_de_sala" data-required="1" type="text" class="form-control" maxlength="300"/>
							</div>
						</div>
