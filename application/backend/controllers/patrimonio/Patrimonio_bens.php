 ...
 * @author    Ralny Andrade | <ra@trivee.com.br> | https://github.com/ralny
 */
class Patrimonio_bens extends MY_Controller 
{
    /**
     * Definir variaveis auxiliares 
     * Define auxiliary variables
     */
    public $modulo  = 'patrimonio_bens';

    public $url     = 'patrimonio/bens';
    ...
    {       
        ...
        $this->load->model('empresa/departamentos/Departamentos_model');
        $this->load->model('patrimonio/Patrimonio_grupos_de_bens_model');
        $this->load->model('patrimonio/Patrimonio_bens_model');
        $this->model = $this->Patrimonio_bens_model;
    ...
    public function listar()
    {
         ...
         * Portlet Title
         */
        $page_data['title_portlet'] = 'Lista de Bens';
         ...
         *
         */
        $page_data['importar'] = base_url().'zata/Import/importar_csv_patrimonio_bens';
        ...
        if (empty($page_data['lista'])) {
             ...
             * View Empty
             */
            $page_data['page'] = 'patrimonio/bens/index';
        } else {
            /**
            * View
            */
            $page_data['page'] = 'patrimonio/bens/main-list';
        }
    ...
    */    
    public function cadastrar()
    {
        ...
        /**
         * Lista situação do bem
         * 
         */ 
        $page_data['lista_situacao_bem']       = $this->Patrimonio_bens_model->combo_list_situacao_bem();

         /**
         * Lista Tipo de Incorporação
         * 
         */ 
        $page_data['lista_tipo_incorporacao'] = $this->Patrimonio_bens_model->combo_list_tipo_incorporacao();

        /**
         * Lista Fornecedores - Combobox
         *
         */
        $page_data['lista_fornecedores'] = $this->model->Clientesfornecedores_model->listar_fornecedores();

        /**
         * Lista grupos de bens
         * 
         */
        $page_data['lista_grupo_bem']    = $this->Patrimonio_grupos_de_bens_model->combo_list_grupo_bem();

        /**
         * Lista departamentos/salas/setores
         * 
         */
        $page_data['lista_departamentos']      = $this->Departamentos_model->combo_list_departamentos();
        
        /**
         * View 
         */
        $page_data['page']          = 'patrimonio/bens/form';
    ...
    */    
    public function editar()
    {
        ...
        if(!$id)
        {
             ...
             */ 
            $this->log_zata->log_error('Danger','Acesso indevido: Patrimonio_bens->editar() --> Parâmetro ID nao numerico');
        ...
        else // Se o parametro esta CORRETO - If the parameter is CORRECT
        {
            ...
            if (!$this->model->getRow($id))
            {
                 ...
                 */
                $this->log_zata->log_error('Error','Acesso invalido: Patrimonio_bens->editar() --> O registro nao foi encontrado no banco de dados. ');
    ...
    */
    function excluir($id) 
    {
        ...
        else
        {
             ...
             */
            $this->log_zata->log_error('Error', 'Falha ao excluir: Patrimonio_bens->excluir() --> Nao foi possivel excluir o registro '. $id);
