...
/**
 * Class Eventos_utilizacao_de_sala
 *
 ...
 * @author    Ralny Andrade | <ra@trivee.com.br> | https://github.com/ralny
 */
class Eventos_utilizacao_de_sala extends MY_Controller
{
    /**
     * Definir variaveis auxiliares
     * Define auxiliary variables
     */
    public $modulo  = 'eventos_utilizacao_de_sala';

    public $url     = 'eventos/config/utilizacao-de-sala';
    ...
    public function __construct()
    {
        ...
        $this->model = $this->Eventos_utilizacao_de_sala_model;
    ...
    public function cadastrar()
    {
         ...
         * View
         */
        $page_data['page']          = 'eventos/utilizacao_de_sala/form';
    ...
    public function editar()
    {
        ...
        if (!$id) {
             ...
             */
            $this->log_zata->log_error('Danger', 'Acesso indevido: Eventos_utilizacao_de_sala->editar() --> Parâmetro ID nao numerico');
            ...
            if (!$this->model->getRow($id)) {
                 ...
                 */
                $this->log_zata->log_error('Error', 'Acesso invalido: Eventos_utilizacao_de_sala->editar() --> O registro nao foi encontrado no banco de dados. ');
                 ...
                 * Portlet Title
                 */
                $page_data['title_portlet'] = 'Editar utilização de sala';
    ...
    public function salvar()
    {
         ...
         */
        $data = array(
            "desc_utilizacao_sala"   => $this->input->post('desc_utilizacao_sala'),
            "desc_definicao"         => $this->input->post('desc_definicao')
        );
    ...
    public function excluir($id)
    {
        ...
        if ($this->model->destroy($id) == true) {
             ...
             */
            $this->log_zata->log_error('Error', 'Falha ao excluir: Eventos_utilizacao_de_sala->excluir() --> Nao foi possivel excluir o registro '. $id);
