...
class Departamentos_model extends MY_Model {
    ...
    */
    ...
    /**
     * combo_list_departamentos 
     *
     * Retorna lista de departamentos de uma empresa - Esta sendo utilizando na tela de cadastro de patrimonio, colocar where depois
     */
    public function combo_list_departamentos(){
