...
/**
 * Class Model Eventos_formato_de_salas 
 *
 ...
 * @author    Ralny Andrade | <ra@trivee.com.br> | https://github.com/ralny
 */
class Eventos_formato_de_salas_model extends MY_Model {
    ...
    */
    public function __construct()
    {
         ...
         * Set the table name
         */
        $this->table    = "eve_formato_de_sala";
        
        /**
         * Definir o nome da chave primaria
         * Define the primary key name
         */
        $this->primaryKey = "id_formato_de_sala";
     ...
     */
    public function listar_formato_de_salas(){
        ...
        $sql = "
                SELECT 	* 
                FROM eve_formato_de_sala 
                WHERE token_company = '$this->company' 
                ORDER BY desc_formato_de_sala
                ";
     ...
     * Retorna lista de status de solicitacao  de servico
     */
    public function listar_formato_de_salas_combo_dinamico($id_sala){
