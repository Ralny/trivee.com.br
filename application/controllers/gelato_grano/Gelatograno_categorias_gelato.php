...
/**
 * Class Gelatograno_categorias_gelato 
 *
 ...
 * @author    Ralny Andrade | <ra@trivee.com.br> | https://github.com/ralny
 */
class Gelatograno_categorias_gelato extends MY_Controller 
{
    /**
     * Definir variaveis auxiliares 
     * Define auxiliary variables
     */
    public $modulo  = 'gelatograno_categorias_gelato';

    public $url     = 'categorias-de-gelato';
    ...
    {       
         ...
         * Loading Model 
         */
        $this->load->model('gelato_grano/Gelatograno_categorias_gelato_model');
        $this->model = $this->Gelatograno_categorias_gelato_model;
    ...
    public function listar()
    {
         ...
         * Portlet Title
         */
        $page_data['title_portlet'] = 'Categorias de Gelato';
         ...
         * View 
         */
        $page_data['page']          = 'gelato_grano/gelatograno_categorias_gelato/main-list';
    ...
    */    
    public function cadastrar()
    {
         ...
         * Portlet Title
         */
        $page_data['title_portlet'] = 'Cadastrar Cetegoria de Gelato';
         ...
         * View 
         */
        $page_data['page']          = 'gelato_grano/gelatograno_categorias_gelato/form';
    ...
    */    
    public function editar()
    {
        ...
        if(!$id)
        {
             ...
             */ 
            $this->log_zata->log_error('Danger','Acesso indevido: Gelatograno_categorias_gelato->editar() --> Parâmetro ID nao numerico');
        ...
        else // Se o parametro esta CORRETO - If the parameter is CORRECT
        {
            ...
            if (!$this->model->getRow($id))
            {
                 ...
                 */
                $this->log_zata->log_error('Error','Acesso invalido: Gelatograno_categorias_gelato->editar() --> O registro nao foi encontrado no banco de dados. ');
            ...
            else
            {
                 ...
                 * Portlet Title
                 */
                $page_data['title_portlet'] = 'Editar Cetegoria de Gelato';
    ...
    */
    public function salvar()
    {
         ...
         */
        $this->input->post('sit_ativo') == 'on' ? $sit_ativo = 'S' : $sit_ativo = 'N';
        ...
        $data = array(
            ...
            "color_label"              => $this->input->post('color_label'),
    ...
    */
    function excluir($id) 
    {
        ...
        else
        {
             ...
             */
            $this->log_zata->log_error('Error', 'Falha ao excluir: Gelatograno_categorias_gelato->excluir() --> Nao foi possivel excluir o registro '. $id);
