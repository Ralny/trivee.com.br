...
class Bi_consumo extends MY_Controller 
{
    ...
    public function dashboard()
    {
        ...
        {   
            ...
            */
            $item_requisicao = $this->model->requisicao_de_item($p->id_produto);
            //$item_requisicao = $this->model->requisicao_de_item(130);

            // Se existe produto requisitado
            if ($item_requisicao != null)
            {       
                //echo $p->nome.' - ' .$p->peso_liquido.' - ' . $item_requisicao->requisitado ; 
                //echo '</br>';         
