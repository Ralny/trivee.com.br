...
/**
 * Class Patrimonio_grupos_de_bens 
 *
 ...
 * @author    Ralny Andrade | <ra@trivee.com.br> | https://github.com/ralny
 */
class Patrimonio_grupos_de_bens extends MY_Controller 
{
    /**
    ...
    */    
    public function editar()
    {
        ...
        if(!$id)
        {
             ...
             */ 
            $this->log_zata->log_error('Danger','Acesso indevido: Patrimonio_grupos_de_bens->editar() --> Parâmetro ID nao numerico');
        ...
        else // Se o parametro esta CORRETO - If the parameter is CORRECT
        {
            ...
            if (!$this->model->getRow($id))
            {
                 ...
                 */
                $this->log_zata->log_error('Error','Acesso invalido: Patrimonio_grupos_de_bens->editar() --> O registro nao foi encontrado no banco de dados. ');
    ...
    */
    function excluir($id) 
    {
        ...
        else
        {
             ...
             */
            $this->log_zata->log_error('Error', 'Falha ao excluir: Patrimonio_grupos_de_bens->excluir() --> Nao foi possivel excluir o registro '. $id);
