 ...
 *
 * Copyright(c) 2015-2019, TRIVEE SERVICES IT
 * 
 ...
 * @copyright TRIVEE SERVICES IT MEI | Copyright (c) 2015 - 2019
 ...
 * @author    Ralny Andrade | <ra@trivee.com.br> | https://github.com/ralny
 */
class Eventos_equipamentos extends MY_Controller 
{
    /**
     * Definir variaveis auxiliares 
     * Define auxiliary variables
     */
    public $modulo  = 'eventos_equipamentos';

    public $url     = 'eventos/config/equipamentos';
    ...
    public function listar()
    {
         ...
         * Portlet Title
         */
        $page_data['title_portlet'] = 'Lista de Equipamentos';
         ...
         *
         */
        $page_data['importar'] = base_url().'zata/Import/importar_csv_eventos_equipamentos';
        ...
        if (empty($page_data['lista'])) {
            ...
            * View Empty
            */
            $page_data['page'] = 'eventos/equipamentos/index';
        } else {
            /**
            * View
            */
            $page_data['page'] = 'eventos/equipamentos/main-list';
        }
    ...
    */    
    public function editar()
    {
        ...
        if(!$id)
        {
             ...
             */ 
            $this->log_zata->log_error('Danger','Acesso indevido: Eventos_equipamentos->editar() --> Parâmetro ID nao numerico');
        ...
        else // Se o parametro esta CORRETO - If the parameter is CORRECT
        {
            ...
            if (!$this->model->getRow($id))
            {
                 ...
                 */
                $this->log_zata->log_error('Error','Acesso invalido: Eventos_equipamentos->editar() --> O registro nao foi encontrado no banco de dados. ');
    ...
    */
    function excluir($id) 
    {
        ...
        else
        {
             ...
             */
            $this->log_zata->log_error('Error', 'Falha ao excluir: Eventos_equipamentos->excluir() --> Nao foi possivel excluir o registro '. $id);
