...
class Eventos_reserva_evento extends MY_Controller 
{
    ...
    */
    public function salvar()
    {
        ...
        $data = array(
            ...
            "numero_reserva"        => $this->gera_numero_numero_reserva_evento($this->input->post('numero_reserva')),
    ...
    * @author    Ralny Andrade | <ra@trivee.com.br> | https://github.com/ralny
    */
    function gera_numero_numero_reserva_evento($numero_re){

        if( $numero_re == '')
        {
            $num_re = $this->model->buscar_num_reserva_evento();
    ...
    */
     ...
     * @author    Ralny Andrade | <ra@trivee.com.br> | https://github.com/ralny
     */ 
    function excluir_reserva_de_sala(){
