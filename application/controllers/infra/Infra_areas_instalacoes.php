 ...
 * @author    Ralny Andrade | <ra@trivee.com.br> | https://github.com/ralny
 */
class Infra_areas_instalacoes extends MY_Controller 
{
    /**
     * Definir variaveis auxiliares 
     * Define auxiliary variables
     */
    public $modulo  = 'infra_areas_instalacoes';

    public $url     = 'infra/infra_areas_instalacoes';
    ...
    {       
        ...
        $this->model = $this->Infra_areas_instalacoes_model;
    ...
    public function listar()
    {
         ...
         * Portlet Title
         */
        $page_data['title_portlet'] = 'Áreas e Instalações';
         ...
         * View 
         */
        $page_data['page']          = 'infra/infra_areas_instalacoes/main-list';
    ...
    */    
    public function cadastrar()
    {
         ...
         * Portlet Title
         */
        $page_data['title_portlet'] = 'Cadastrar Áreas e Instalações';
         ...
         * View 
         */
        $page_data['page']          = 'infra/infra_areas_instalacoes/form';
    ...
    */    
    public function editar()
    {
        ...
        if(!$id)
        {
             ...
             */ 
            $this->log_zata->log_error('Danger','Acesso indevido: Infra_areas_instalacoes->editar() --> Parâmetro ID nao numerico');
        ...
        else // Se o parametro esta CORRETO - If the parameter is CORRECT
        {
            ...
            if (!$this->model->getRow($id))
            {
                 ...
                 */
                $this->log_zata->log_error('Error','Acesso invalido: Infra_areas_instalacoes->editar() --> O registro nao foi encontrado no banco de dados. ');
            ...
            else
            {
                 ...
                 * Portlet Title
                 */
                $page_data['title_portlet'] = 'Editar Áreas e Instalações';
    ...
    */
    function excluir($id) 
    {
        ...
        else
        {
             ...
             */
            $this->log_zata->log_error('Error', 'Falha ao excluir: Infra_areas_instalacoes->excluir() --> Nao foi possivel excluir o registro '. $id);
